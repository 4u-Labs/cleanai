...
<body>
    <div class="terms-container">
        ...
        <div class="footer-info">
            &copy; <?= $year ?> CleanAI 4U &bull; Desenvolvido por <a href="https://4u.ia.br" target="_blank">4U.IA.BR</a> &bull; Código no <a href="https://github.com/4u-Labs" target="_blank">GitHub</a>
        </div>
    </div>
</body>
</html>
